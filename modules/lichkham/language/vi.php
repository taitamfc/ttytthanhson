...
$lang_module['yeucau_ok'] = 'Cảm ơn quý khách đang đặt lịch trực tuyến. Chúng tôi sẽ sớm liên hệ lại quý khách để xác nhận thông tin.';
$lang_module['yeucau_err'] = 'Rất tiếc, Yêu cầu đặt lịch của quý khách chưa gửi đi được. Xin vui lòng kiểm tra lại';
