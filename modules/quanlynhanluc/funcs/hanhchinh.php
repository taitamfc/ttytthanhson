...
if (empty($user_info)){	$url = MODULE_LINK . '&' . NV_OP_VARIABLE . '=login';nv_redirect_location($url); exit();}
	...
	if ($sta=='edit_item')
	{
		...
		else {$ketqua['status']='err'; $ketqua['mess']= $tb;}
	...
	$quyen=check_quyen($user_info); $admin=array('admin','admin01','dieuduong');
	if ($quyen>100 or in_array($user_info['username'], $admin))
	{
		$temp='admin';
