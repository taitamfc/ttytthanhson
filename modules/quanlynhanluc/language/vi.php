...
$lang_module['yeucau_ok'] = 'Thao tác xử lý của bạn đã được gửi, Vui lòng theo dõi cập nhật từ hệ thống!!!';
...
$lang_module['bs_lamsang'] = 'Số bác sĩ làm lâm sàng';
$lang_module['so_giuong'] = 'Số giường bệnh thực kê';
$lang_module['bn_c1'] = 'BN cấp I';
$lang_module['c1_toandien'] = 'Số bệnh nhân Cấp I được chăm sóc toàn diện';
$lang_module['bn_c2'] = 'BN cấp II';
$lang_module['c2_toandien'] = 'Số bệnh nhân Cấp II được chăm sóc toàn diện';
$lang_module['bn_c3'] = 'BN cấp III';
$lang_module['c3_toandien'] = 'Số bệnh nhân Cấp III được chăm sóc toàn diện';
$lang_module['goi_dau'] = 'Gội đầu';
$lang_module['tam_kho'] = 'Tắm khô';
$lang_module['xong_hoi'] = 'Xông hơi cho sản phụ';
$lang_module['tam_be'] = 'Tắm bé';
$lang_module['massage'] = 'Matxa trẻ';
$lang_module['xoay'] = 'Xoay sở';
$lang_module['vo_rung'] = 'Vỗ rung';
$lang_module['ca_de'] = 'Số ca đẻ';
$lang_module['phau_thuat'] = 'Số ca phẫu thuật';
$lang_module['bn_loet'] = 'Số người bệnh mới bị loét do tỳ đè ';
$lang_module['bn_viem'] = 'Số người bệnh mới bị viêm phổi do ứ đọng';

$lang_module['bn_cu']='BN cũ';
$lang_module['bn_vaovien']='BN vào viện';
$lang_module['bn_ravien']='BN ra viện';
$lang_module['bn_chuyenkhoa']='BN chuyển khoa';
$lang_module['bn_chuyenvien']='BN chuyển viện';
$lang_module['bn_xinve']='Bn xin về';
$lang_module['bn_noitru']='Số BN nội trú';
$lang_module['bn_ngoaitru']='Số BN ngoại trú';
$lang_module['bn_namyc']='Tổng số BN nằm giường yêu cầu';
$lang_module['bn_tuvong']='Tử vong';
$lang_module['bn_tong']='Tổng số BN';

$lang_module['sobn_bhyt']='Số bệnh nhân khám theo chế độ BHYT';
$lang_module['bn_noitinh']='Số BN Nội tỉnh ';
$lang_module['bn_ngoaitinh']='Số BN Ngoại tỉnh';
$lang_module['bnkham']='Số bệnh nhân khám viện phí';

$lang_module['baocao1']='Tổng số cán bộ đi làm hiện tại';
$lang_module['baocao2']='Tổng số bệnh nhân (cả nội trú và ngoại trú)';
$lang_module['baocao3']='Tổng số bệnh nhân nội trú';
$lang_module['baocao4']='Tỷ lệ điều dưỡng/bác sĩ lâm sàng hiện tại';
$lang_module['baocao5']='Tỷ lệ điều dưỡng chăm sóc/Giường bệnh thực kê hiện tại';
$lang_module['baocao6']='Tỷ lệ điều dưỡng/người bệnh hiện tại';
$lang_module['baocao7']='Tỷ lệ điều dưỡng/người bệnh nội trú';
