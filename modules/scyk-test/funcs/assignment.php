...
if (isset($post['submit'])) {
    ...
    $capnhat =  $data_insert['thoigian'];
    $st2 = "INSERT INTO " . TABLE . "_voted_result_b (masobc_b,capnhat) " . "VALUES('" . $masobc_b . "','" . $capnhat . "')";
    //echo $st2;
    $row_id2 = $db->exec($st2);
        ...
        switch ($row['type_control']) {
            ...
            case 'radiog':
                ...
                <div class="border p-3 rounded">                    
                    ...
                    <label class="w-100">
                    <input type="radio" id="radCreateMode" name="' . $row['controlname'] . '" id="idradiog' . $id . '" value="' . $row['title'] . '"
  ...
  ' . $row['title'] . '
            ...
            case 'datetime':
                ...
                <label class="form-label">' . $row['title'] . '</label>
                    ...
                    placeholder="dd/mm/yyyy" value="' . $capnhat . '" >
                    </div>';
                break;
            ...
            case 'date':
                ...
                <input readonly type="text" placeholder="dd/mm/yyyy"  class="form-control form-control-lg"  name="' . $row['controlname'] . '" id="datepicker" placeholder="Chọn ngày sinh" />
                </div>';
                break;
