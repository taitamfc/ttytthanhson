...
if ($get['id_year'] > 0) {
	...
	//tính tỷ lệ %
	$tonghop['rattot'] = ($tonghop['rattot']/$tonghop['slkp'])*100;
	$tonghop['tot'] = ($tonghop['tot']/$tonghop['slkp'])*100;
	$tonghop['trungbinh'] =($tonghop['trungbinh']/$tonghop['slkp'])*100;
	$tonghop['yeu'] = ($tonghop['yeu']/$tonghop['slkp'])*100;
