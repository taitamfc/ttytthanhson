...
// $get['id']=1;
// Đưa thông tin link vào các nút nhấn
$links = array();
$token = md5($client_info['session_id'] . $user_info['username']);
$links['func1'] ='report_content';
$links['func2'] ='report_detail';
$link['info'] = MODULE_LINK . '&' . NV_OP_VARIABLE . '=';
$links['xem_tonghop'] = MODULE_LINK . '&' . NV_OP_VARIABLE . '=' . $links['func1'];
$links['xem_chitiet'] = MODULE_LINK . '&' . NV_OP_VARIABLE . '=' . $links['func2'];
// print($links['test']);
// $links['xem_tonghop'] = $links['info'] . $links['func1'] ."_". $token;

$links['in_tonghop'] =$links['info'] ;

$xtpl->assign('LINK', $links);
