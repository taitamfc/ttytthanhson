...
<div class="panel panel-default">
    <div class="panel-heading">
        <h3 class="panel-title" style="float:left"><i class="fa fa-list"></i> {LANG.department}</h3> 
        <div class="pull-right">
           ...
           <a href="{department_add}" data-toggle="tooltip" data-placement="top" title="{LANG.department_add}" class="btn btn-success btn-sm"><i class="fa fa-plus-circle" aria-hidden="true"></i></a>
       </div>
        ...
        <div class="row">
            ...
            <div class="col-xs-24 col-sm-12  col-md-12  col-lg-8">
                <div class="form-group">
                    ...
                    placeholder="{LANG.name_department}" />
                </div>
            </div>
        ...
        <table class="table table-striped table-bordered table-hover">
            <thead>
                <tr>
                    ...
                    <th class="text-center" style="vertical-align: middle;">{LANG.department_code}</th>
                    <th class="text-center" style="vertical-align: middle;">{LANG.name_department}</th>
                    <th class="text-center" style="vertical-align: middle;">{LANG.userid_manager}</th>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-center" style="vertical-align: middle;"> {VIEW.department_code} </td>
                    <td class="text-center" style="vertical-align: middle;"> {VIEW.name_department} </td>
