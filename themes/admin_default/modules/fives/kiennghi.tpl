                ...
                <div class="form-group">
                    <div class="input-group" style="width:100%">
                        <span class="input-group-addon tms-addon">
                          ...
                          <select id="row_id" name="row_id" class="form-control input-sm" onchange="load_static_kiennghi()"> </select>
                    </div>
                </div>
            </div>
            ...
            <div class="col-xs-24 col-sm-24  col-md-12  col-lg-12">
                <div class="form-group">
                    <div class="input-group" style="width:100%">
                        ...
                        <select id="department_id" class="form-control input-sm"onchange="load_static_kiennghi()">
                        </select>
                    </div>
                </div>
            </div>
