...
<div class="panel panel-default">
    <div class="panel-heading">
        <h3 class="panel-title" style="float:left"><i class="fa fa-list"></i> {LANG.list_fives_list}</h3> 
        ...
        <table class="table table-striped table-bordered table-hover">
            <thead>
               <tr>
                    ...
                    <th class=" text-center">{LANG.list_fives}</th>
                    <th class=" text-center">{LANG.time_from}</th>
                    <th class=" text-center">{LANG.time_to}</th>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td> {VIEW.time_to} </td>
                    <td class="text-center"> {VIEW.user_add}</td>
                    <td class="text-center"> {VIEW.time_add} </td>
...
<form class="form-horizontal" action="{NV_BASE_ADMINURL}index.php?{NV_LANG_VARIABLE}={NV_LANG_DATA}&amp;{NV_NAME_VARIABLE}={MODULE_NAME}&amp;{NV_OP_VARIABLE}={OP}&action=add" method="post">
    <input type="hidden" name="id" value="{ROW.id}" />
       <div class="form-group">
        <label class="col-sm-5 col-md-4 control-label"><strong>{LANG.list_fives}</strong> <span class="red">(*)</span></label>
        <div class="col-sm-19 col-md-20">
            <input class="form-control" type="text" name="title" value="{ROW.title}" required="required" oninvalid="setCustomValidity(nv_required)" oninput="setCustomValidity('')" />
        </div>
    </div>
     <div class="form-group">
        <label class="col-sm-5 col-md-4 control-label"><strong>{LANG.time_from}</strong> <span class="red">(*)</span></label>
        <div class="col-sm-8 col-md-8">
            <div class="input-group">
            <input class="form-control" type="text" name="time_from" value="{ROW.time_from}" id="time_from" pattern="^[0-9]{2,2}\/[0-9]{2,2}\/[0-9]{1,4}$" required="required" oninvalid="setCustomValidity(nv_required)" oninput="setCustomValidity('')" />
    ...
    <div class="form-group">
        <label class="col-sm-5 col-md-4 control-label"><strong>{LANG.time_to}</strong> <span class="red">(*)</span></label>
        <div class="col-sm-8 col-md-8">
            <div class="input-group">
            <input class="form-control" type="text" name="time_to" value="{ROW.time_to}" id="time_to" pattern="^[0-9]{2,2}\/[0-9]{2,2}\/[0-9]{1,4}$" required="required" oninvalid="setCustomValidity(nv_required)" oninput="setCustomValidity('')" />
                <span class="input-group-btn">
