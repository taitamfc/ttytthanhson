	...
	<table class="table table-hover" >
            <thead>
				<tr>
					...
					THÁNG ÁP DỤNG THỰC HIỆN CỦA {namapdung}</th>
                </tr>
				<tr>
					<!-- BEGIN: thang -->
                    <td class="text-center"> 
						<div onclick="setdefault_item('{ITEM.link}','{ITEM.token}')" class="btn {ITEM.cls_div}"><span style="font-weight: bold;{ITEM.color}">{ITEM.thang}</span></div>
					</td>
					<!-- END: thang -->
                </tr>
