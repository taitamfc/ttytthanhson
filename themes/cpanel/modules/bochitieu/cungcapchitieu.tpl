	...
	<div class="col-sm-12">
        ...
        <div class="card">
            <div class="card-header">
                <h4 class="m-b-10" style="text-transform: uppercase;">CHI TIẾT KIỂM TRA BỆNH VIỆN KỲ ĐÁNH GIÁ THÁNG {KY.thangapdung} năm {KY.nam}</h4>
            </div>			
                    ...
                    <table class="table table-hover" >
						...
						<table class="table table-hover" >	
								...
								<tr>									
									...
									<td class="text-center"> 
										<div class="btn label-inverse-default">
										<span style="font-weight: bold;color:#000">{KQ.diem_namngoai}</span></div>
									</td>
