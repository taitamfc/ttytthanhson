...
<div class="card-block" id="block_rp">
	...
	(Tiêu chí C3 và C5 có hệ số 2)<br/>
		...
		<div class="row">					
			...
			<tbody>
			<tr>
				<td class=""><h5>III. TÓM TẮT CÔNG VIỆC TỰ KIỂM TRA BỆNH VIỆN</h5></td>
			</tr>
			<tr>
		...
		<div class="row">		
			...
			<tbody>
			<tr>
				<td class=""><h5>V. TỰ ĐÁNH GIÁ VỀ CÁC ƯU ĐIỂM CHẤT LƯỢNG BỆNH VIỆN</h5>
			...
			<tr>
				<td class=""><h5>VI. TỰ ĐÁNH GIÁ VỀ CÁC NHƯỢC ĐIỂM, VẤN ĐỀ TỒN TẠI </h5>
				</td>
			</tr>
			<tr>
			...
			<tr>
				<td class=""><h5>VII. XÁC ĐỊNH CÁC VẤN ĐỀ ƯU TIÊN CẢI TIẾN CHẤT LƯỢNG </h5>
				</td>
			</tr>
			...
			<tr>
				<td class=""><h5>VIII. GIẢI PHÁP, LỘ TRÌNH, THỜI GIAN CẢI TIẾN CHẤT LƯỢNG</h5>
				</td>
			</tr>
			<tr>
...
scale: {max: 5,min: 0, ticks: {stepSize: 0.5}}};
<!-- BEGIN: loopchart -->
