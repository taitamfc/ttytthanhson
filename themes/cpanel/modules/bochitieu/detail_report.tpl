	...
	<table class="table table-hover" >
            <thead>
				...
				<tr>
					...
					<div class="btn col-sm-6" style="text-align: right;"> <span style="font-weight:Bold">CHỌN THÁNG XEM BÁO CÁO:</span></div>
					<div class="btn col-sm-6">
						<select onchange="view_report(this,'{link_frm}');" 
...
function view_report(a,token) {
	var url=nv_base_siteurl+nv_module_name+'/'+nv_func_name+'/?sta=viewreport&id='+a.value;
	alert(url);
}
