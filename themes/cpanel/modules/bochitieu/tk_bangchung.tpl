...
<div class="card-block" id="block_rp">
	...
	THỐNG KÊ SỐ LƯỢNG BẰNG CHỨNG ĐÁNH GIÁ </strong>
	<br /> 
		<div class="col-sm-12">
			<table  class="table table-bordered border-primary">
				...
				<th class="text-center  align-middle">Số bằng chứng</th>
				...
				<!-- BEGIN: chitieu -->
					...
					<tr style="color: #000;">
						...
						<td class="text-center phanhang"><strong>{KQ.tong_bc}</strong></td>
						<td class="text-center">
						<button class="btn btn-success btn-mini waves-effect waves-light" id="view" onclick="openForm('{link_viewfile}');">
