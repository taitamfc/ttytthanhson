...
<div class="card-block" id="block_rp">
	...
	THỐNG KÊ CÁC TIÊU CHÍ TĂNG ĐIỂM SO VỚI NĂM {BC.namngoai}
	...
	<br /> (ÁP DỤNG CHO CÁC KHOA PHÒNG TỰ KIỂM TRA, ĐÁNH GIÁ)</div> 
		<div class="row">
			<table class="table table-borderless" style="width:100%">
				...
				<tr><td class="text-left"><strong>I. KẾT QUẢ TỰ KIỂM TRA, ĐÁNH GIÁ CÁC TIÊU CHÍ CHẤT LƯỢNG TĂNG ĐIỂM SO VỚI NĂM {BC.namngoai}</strong></td> </tr>	
				</tbody>
			<table>
		</div>
