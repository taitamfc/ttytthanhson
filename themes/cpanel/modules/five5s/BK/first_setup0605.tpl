					...
					<div class="card">
						...
						<div class="card-block">
							...
							<p style="color:#ff0000">
								...
								<a onclick="setdefault_item('{ACT.link}','{ACT.token}')"
									...
									<thead>
										<tr style="text-transform: uppercase;background-color: #2e8ed8; color:white">
											<th scope="row" class="text-center" colspan="4"><i
													class="icofont icofont-paper-plane">CẬP NHẬT THÔNG TIN LẦN ĐÁNH GIÁ
													SỐ
								...
								<div class="row">
									<div class="label-main">
										<!-- BEGIN: view -->
											...
											<label class="label label-info">{KHOAPHONG.khoa}</label>
											
										<!-- END: view -->
									</div>
								</div>
								<div class="row">
									<div class="col-3"> <a href="{ROW.link_danhgia}"
											class="btn btn-mini btn-primary btn-round">
											<i class="fa fa-file-text-o"></i> Đánh giá</a> </div>
									<div class="col-3"> <a href="{ROW.link_baocao}"
											class="btn btn-mini btn-primary btn-round">
											<i class="fa fa-file-text-o"></i> Xem báo cáo</a> </div>
									<div class="col-3"> <a href="{ROW.link_edit}"
											class="btn btn-mini btn-primary btn-round"> <i class="fa fa-edit"></i> Chỉnh
											sửa</a> </div>
									<div class="col-3"> <button onclick="del_item('{ROW.link_del}','{ROW.token}')"
											class="btn btn-mini btn-primary btn-round"> <i class="fa fa-trash"></i> Xóa
											biểu mẫu</button> </div>
