        ...
        <div class="card-block">
          ...
          <form class="md-float-material" action="{link_frm}" method="post" id="myform">
                    ...
                    <div class="card-header">
                      ...
                      <div class="hidden">
                        <b><i class="fa fa-hand-o-right" aria-hidden="true">
                            ...
                            class="label {thongtinchung.class}label-danger">{thongtinchung.trangthai}Đã hoàn
                            thành</span></b>
                      </div>
            ...
            <tr>
              ...
              <th class="tieumuc text-left" rowspan="2" style="vertical-align:middle">

                TÊN KHOA PHÒNG
              </th>


              <th class="tieumuc text-center" colspan="12">
                CHI TIẾT LẦN ĐÁNH GIÁ
              </th>
            ...
            <tr>
              ...
              <th class="tieumuc text-center">LẦN 1</th>
              <th class="tieumuc text-center">LẦN 2</th>
              <th class="tieumuc text-center">LẦN 3</th>
              <th class="tieumuc text-center">LẦN 4</th>
              <th class="tieumuc text-center">LẦN 5</th>
              <th class="tieumuc text-center">LẦN 6</th>
              <th class="tieumuc text-center">LẦN 7</th>
              <th class="tieumuc text-center">LẦN 8</th>
              <th class="tieumuc text-center">LẦN 9</th>
              <th class="tieumuc text-center">LẦN 10</th>
              <th class="tieumuc text-center">LẦN 11</th>
              <th class="tieumuc text-center">LẦN 12</th>
                  ...
                  <thead>
                    ...
                    <tr data-b-a-s="thin">
                      <th data-f-bold="true" data-a-v="middle" data-f-sz="12" data-f-name="Times New Roman"
                        data-b-a-s="thin" style="width:2%;" colspan="1" rowspan="2" class=" title text-center header">
                        STT
                      </th>
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td data-f-sz="12" data-f-name="Times New Roman" data-f-bold="true" data-b-a-s="thin" colspan="10"
                        class="title"> <strong> {group.stt}. {group.name_question_type} </strong> </td>
...
<script>
  ...
  function printDiv1(divName) {
    var divToPrint = document.getElementById('bieumau');
    var htmlToPrint = '' +
      '<style type="text/css">' +
