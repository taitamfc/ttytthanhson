                ...
                <div class="clone-item first-clone">
                    <div class="clone-input">
                        <div class="mb-3">
                            ...
                            <input name="benh_nhan_theo_doi[khoa_hscc][tieude][]" class="form-control" type="text">
                        </div>
                        <div class="mb-3">
                            <label class="form-label">Nội dung báo cáo</label>
                            <textarea name="benh_nhan_theo_doi[khoa_hscc][noidung][]" class="form-control"></textarea>
                        </div>
                    </div>
