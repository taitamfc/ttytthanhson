...
<table class="table table-hover table-bordered">
    ...
    <tr>
        ...
        <td>Ngoại tỉnh</td>
        <td><input type="number" class="form-control w80 has_f f_khoakb benh_nhan_kham_phuthu pkdk_bhyt_ngoaitinh" name="tinh_hinh_benh_nhan[pkdk][bhyt][ngoaitinh]" value="{item.tinh_hinh_benh_nhan.pkdk.bhyt.ngoaitinh}">  </td>
    </tr>
    <tr>
        <td>Nội tỉnh</td>
        <td><input type="number" name="tinh_hinh_benh_nhan[pkdk][bhyt][noitinh]" class="form-control w80 has_f f_khoakb benh_nhan_kham_phuthu pkdk_bhyt_noitinh" value="{item.tinh_hinh_benh_nhan.pkdk.bhyt.noitinh}"></td>
    </tr>
    <tr>
