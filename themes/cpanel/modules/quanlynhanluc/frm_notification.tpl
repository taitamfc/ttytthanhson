                    ...
                    <table id="tbl_danhsach" class="table table-hover" >
						...
						<!-- BEGIN: loop -->
                            ...
                            <tr style="{ROW.new}" >
                                ...
                                <td style="padding-top: 15px;" onclick="setValue('{ROW.link_view}','panel_chitiet');">{ROW.tieude}</td>
...
<!-- BEGIN: step0 -->
        <a class="accordion-msg"><i class="icofont icofont-location-arrow"> Lý do từ chối phê duyệt</i></a>
        <div class="accordion-desc">
			<div class="card borderless-card">
				<div class="card-block  danger-breadcrumb">
					<div class="breadcrumb-header">
						<h5>{DATA.ghichu_duyet}</h5>
					</div>
...
<!-- BEGIN: step3 -->
		...
		<div class="table-responsive">
			<table class="table table-hover">
				...
				<tfoot>
					<tr>
						<th class="text-center" colspan="9"><button type="button" class="btn btn-danger text-center" onclick="finish_dieudong('{link_frm}','{DATA.code_pro}');">
								<i class="ti-close"></i><strong>Kết thúc điều động </strong>
						</button></th>						
					</tr>
				</tfoot>
				<!-- END: finish -->
				...
				<table class="table table-hover" id="tbl_dd">
					...
					<tfoot>	
						...
						<tr>
							<td class="text-left" colspan="6">
							<h6>Ghi chú</h6>
								<textarea id="ghichu_duyet" name="ghichu_duyet" rows="5" cols="25" class="form-control form-control-success">{DATA.lydo}</textarea>
							</td>
						</tr>
						<tr>
							<td class="text-center" colspan="6">								
							...
							<button type="button" class="btn btn-danger text-center" onclick="cancle_dieudong('{link_frm}','{DATA.code_pro}');">
								<i class="ti-close"></i><strong>Hủy Phê Duyệt</strong>
							</button>
							</td>
						</tr>
