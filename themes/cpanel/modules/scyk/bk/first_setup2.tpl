							...
							<div id="bieumau1">
								...
								<form name="nmyform2" id="myform2" action="#" method="post"
									...
									<div class="card-block">
										...
										<table id="mytable{NHOMCAUHOI2B.stt}" class="table table-hover"
											style="width:100%;{NHOMCAUHOI.testdisplay}">
										...
										<div class="hidden1A">
											<!-- BEGIN: NHOMCAUHOI1A -->
											<div class="hiddendv header bg-success text-white p-2">
												{NHOMCAUHOI1A.stt}. {NHOMCAUHOI1A.tennhom}
											</div>
											<table id="mytable{NHOMCAUHOI1A.stt}" class="hiddentbl table table-hover"
												style="width:100%;{NHOMCAUHOI1A.testdisplay}">
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<form name="nmyform4" id="myform4" action="#" method="post" onsubmit="frm_submit(this);">
					...
					<textarea id="idnote" name="note" rows="4" class="form-control form-control-lg"
					> {NOTE} </textarea>
					<hr></hr>
