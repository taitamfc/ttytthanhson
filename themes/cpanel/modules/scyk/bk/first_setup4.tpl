						...
						<div class="card">
							...
							<div class="container mt-4">
								...
								<div class="accordion" id="outerAccordionA">
									...
									<div class="card">
										<div class="card-header bg-primary text-white py-2" id="headingOne">
											...
											<div class="card-body">
												...
												<div class="accordion" id="nestedAccordionA">
													...
													<div class="card">
														...
														<div id="nestedCollapse{NHOMCAUHOI.stt}A" class="collapse"
															data-parent="#nestedAccordionA">
															<div class="card-body">
												...
												<div class="accordion" id="nestedAccordionTwo">
																	...
																	<table class="table phuluc1 table-hover"
																		...
																		<tbody>
																			<tr>
																				...
																				<td style="vertical-align: middle;">Chưa
																					xảy ra (NC0)</td>
																				<th rowspan="6"
																					style="vertical-align: middle;">Báo
																					cáo
																					tự nguyện</th>
																			...
																			<tr>
																				...
																				<td rowspan="3"
																					style="vertical-align: middle;">Tổn
																					thương nhẹ[1] (NC1)</td>
																			...
																			<tr>
																				<td>5</td>
																				<td>Sự cố đã xảy ra gây nguy hại tạm
																			...
																			<tr>
																				<td>7</td>
																				<td>Sự cố đã xảy ra gây nguy hại kéo
																					dài, để lại di chứng (kèm theo bảng
																					sự cố y khoa nghiêm trọng)</td>
																			...
																			<tr>
																				<td>8</td>
																				<td>Sự cố đã xảy ra gây nguy hại cần
																			...
																			<tr>
																				<td>9</td>
																				<td>Sự cố đã xảy ra có ảnh hưởng hoặc
													...
													<div class="card">
														<div class="card-header bg-info text-white py-1"
															...
															<button class="btn btn-link text-white" type="button"
																data-toggle="collapse" data-target="#nestedCollapseFour"
																aria-expanded="false">
															...
															<div class="card-body">
																...
																<div class="card-header bg-success text-white py-1"
																	...
																	<button class="btn btn-link text-white"
																		...
																		aria-expanded="false">
																		{NHOMCAUHOI2B.stt}. {NHOMCAUHOI2B.tennhom}
																	</button>
																</div>
													...
													<div class="card">
														<div class="card-header bg-info text-white py-1"
															id="nestedHeading3B">
															<button class="btn btn-link text-white" type="button"
																data-toggle="collapse" data-target="#nestedCollapse3B"
																aria-expanded="false">
															...
															<div class="card-body">
																...
																<div class="card-header bg-success text-white py-1"
																	...
																	<button class="btn btn-link text-white"
																		...
																		aria-expanded="false">
																		{NHOMCAUHOI3B.stt}. {NHOMCAUHOI3B.tennhom}
																	</button>
																</div>
													...
													<div class="card">
														<div class="card-header bg-info text-white py-1"
															id="nestedHeading4B">
															<button class="btn btn-link text-white" type="button"
																data-toggle="collapse" data-target="#nestedCollapse4B"
																aria-expanded="false">
								...
								<div class="row ">
									...
									<div class="col-auto">
										...
										<button type="submit" class="btn btn-out-dashed btn-success btn-square"
											...
											<i class="icofont icofont-check-circled"></i> Duyệt BC</button>
									</div>
										...
										<table id="mytable2" class="table table-hover" style="width:100%">
											...
											<tr>
												<th class="bg-info text-white p-2">
													...
													<input type="hidden" id="idcheckbut{NHOMCAUHOI2.numv}"
														name="checkbut{NHOMCAUHOI2.numv}" />
												</th>
											</tr>
											<!-- BEGIN: CAUHOI2-->
											<tr>
								...
								<div class="row ">
									...
									<div class="col-auto">
										<button type="submit" class="btn btn-out-dashed btn-info btn-square"
											id="id_ptsc" name="btn_ptsc" {TT.PHANTICH}>
