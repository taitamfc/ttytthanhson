      ...
      <div class="card">
        <div class="card-block">
          ...
          <form class="md-float-material" action="{link_frm}" method="post" id="myform" enctype="multipart/form-data">
            ...
            <td colspan="2">
              <div class="input-group">
                <span class="input-group-addon" style="width: auto;min-width:100px;">Chọn
                  Lần Đánh Giá:</span>
                <select name="cbo_count" id="count" class="form-control" placeholder="Lần đánh giá" title=""
                  data-toggle="tooltip" data-original-title="Lần đánh giá">
                  <!-- BEGIN: setcount -->
                  <option value="{setcount.count}" {setcount.selected}>Số {setcount.count}</option>
                  <!-- END: setcount-->
                </select>
              </div>
            </td>
        ...
        <tr style="background-color: #e8edea;border-color: #73b4ff;outline: 1px dashed #fff;outline-offset: -5px;">
          ...
          <td class="text-center col-2">
            <input id="start-date" name="from_date" value="{from_date}" type="text"
          ...
          <td class="text-center col-2">
            <input id="end-date" name="to_date" value="{to_date}" type="text" class="dataValue form-control bg-success"
              readonly disabled />
          </td>
        ...
        <tr style="background-color: #e8edea;border-color: #73b4ff;outline: 1px dashed #fff;outline-offset: -5px;">
          ...
          <td class="text-center col-2">
            <input id="current-date" name="created_date" value="{created_date}" type="text"
              class="dataValue form-control bg-warning" readonly />
          </td>
        ...
        <div class="accordion-block color-accordion-block">
          <div class="color-accordion ui-accordion ui-widget ui-helper-reset" id="color-accordion" role="tablist">
            ...
            <a class="accordion-msg b-none ui-corner-top ui-state-default ui-accordion-icons scale_active ui-accordion-header-collapsed ui-corner-all"
              ...
              tabindex="-1">
              <span class="ui-accordion-header-icon ui-icon zmdi zmdi-chevron-down"></span>
              <strong>NHẬN XÉT - ĐỀ XUẤT, KIẾN NGHỊ</strong></a>
            <div class="accordion-desc ui-accordion-content ui-corner-bottom ui-helper-reset ui-widget-content"
              style="display: none;" id="ui-id-14" aria-labelledby="ui-id-13" role="tabpanel" aria-hidden="true">
              <p>
              <table id="myTable" class="cell-border table table-hover" style="width:100%">
                <thead>
                  ...
                  <tr>
                    <td><textarea id="limitation" name="name_limitation" rows="5"
                        class="form-control">{limitation}</textarea>
                    </td>
                  </tr>

                  <tr>
                    <td class="class=" align-middle text-left col-1"">
                      <label for="id_evaluation_type">Đề Xuất, Khuyến Nghị</label>
                    </td>
                  </tr>
                  <tr>
                    <td><textarea id="recommendation" name="name_recommendation" rows="5"
                        class="form-control">{recommendation}</textarea>
                    </td>
                  </tr>
                </thead>
                <tfoot>
...
<script type="text/javascript">
  $(function() {
    ...
    $("#account").change(function() {
      ...
      var url = '{link_frm}';
      vl1 = $(this).val();
      window.location = url + '&idd=' + vl1 + '_' + vl2;
    });
  ...
  $(document).ready(function() {
    ...
    $('#start-date').datepicker({
      onSelect: function(selectedDate) {
        ...
        $('#current-date').datepicker('option', 'minDate', selectedDate);
      }
    });
    ...
    $('#end-date').datepicker({
      onSelect: function(selectedDate) {
        ...
        $('#current-date').datepicker('option', 'maxDate', selectedDate);
      }
    });
