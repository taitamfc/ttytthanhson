  ...
  <div class="row">
    ...
    <div class="col-md-6">
      ...
      <div class="box box-danger">
        <div class="box-header with-border">
          ...
          <table class="table-boder">
            <tr>
              <!-- BEGIN: KHOAPHONG1 -->
              <td style="text-align: left;"><span id="sp-kp" class="badge badge-info mr-1"
            ...
            <tr>
              ...
              <td style="text-align: left;">
                <a onclick="get_khoaphong_lan(this);"" ><span id=" sp-kp"
                  class="badge badge-info">{KHOAPHONG2.account}</span> </a>
              </td>
              <!-- END: KHOAPHONG2 -->
            </tr>
            <tr>
              ...
              <td style="text-align: left;">
                <a onclick="get_khoaphong_lan(this);"" ><span id=" sp-kp"
                  class="badge badge-info">{KHOAPHONG3.account}</span> </a>
              </td>
              <!-- END: KHOAPHONG3 -->
            </tr>
          </table>
      ...
      <div class="box box-primary">
        <div class="box-header with-border">
          <h5 class='text-left'>Biểu đồ 4: Đang cập nhật</h5>

          <div class="box-tools pull-right"></span>
            <button type="button" class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-minus"></i>
            </button>
          </div>
        </div>
        <div class="box-body chart-responsive">
          <div class="chart" id="5s-chart" style="height: 300px; -webkit-tap-highlight-color: rgba(0, 0, 0, 0);">
    ...
    <div class="col-md-6">
      ...
      <div class="box box-danger">
        <div class="box-header with-border">
          <h3 class="box-title">Tỷ lệ xếp loại toàn viện</h3>
          <div class="box-tools pull-right">
            <button type="button" class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-minus"></i>
            </button>
        ...
        <div class="box-body chart-responsive">
          <div class="chart chart_morris" id="pie-kp" style="height: 230px; position: relative;"></div>
    ...
    <div class="col-md-6">
      ...
      <div class="box box-info">
        <div class="box-header with-border">
          <h3 class="box-title">Biểu đồ 6-Đang cập nhật</h3>
...
<script src="{BASE_URL}{NV_ASSETS_DIR}/js/morris-chart/jquery.min.js"></script>

<script src="{BASE_URL}{NV_ASSETS_DIR}/js/morris-chart/raphael.min.js"></script>
...
function get_randcolor(num) {
  var colors = ["red", "blue", "green", "yellow", "pink", "purple", "orange", "yellow-green", "red-violet", "brown", "blue-green"];
  var randomColors = [];
  for (var i = 0; i < num; i++) {
          ...
          hoverCallback: function(index, options, content, row) {
            ...
            ykeys.forEach(function(key, i) {
              ...
              if (value) {
                ...
                tooltip += '<i class="fas fa-square"></i> ' + ykeys[i] + ': ' + value;
                tooltip += '</div>';
              }
            });
