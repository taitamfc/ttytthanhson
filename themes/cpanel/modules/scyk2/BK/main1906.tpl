...
<section class="content">
  ...
  <div class="row">
    ...
    <div class="col-md-6">
      ...
      <div class="box box-info">
        <div class="box-header with-border">
          <h6 class="text-center">Biểu đồ 1: TỔNG HỢP KẾT QUẢ ĐÁNH GIÁ 5S CỦA BỆNH VIỆN</BR> Ở CÁC LẦN ĐÁNH GIÁ KHÁC NHAU </h6>
    ...
    <div class="box-header with-border">
    {testcode}
      <h6 class='text-center'>Biểu đồ 2: TỔNG HỢP KẾT QUẢ ĐÁNH GIÁ 5S TẠI MỘT ĐƠN VỊ </BR> Ở CÁC LẦN ĐG KHÁC NHAU</h6>
    ...
    <div class="col-md-6">
      ...
      <div class="box box-danger">
        <div class="box-header with-border">
          <h6 class="text-center">Biểu đồ 4:TỶ  LỆ XẾP LOẠI TOÀN VIỆN</h6>
          <div class="box-tools pull-right">
            <button type="button" class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-minus"></i>
            </button>
    ...
    <div class="col-md-6">
      ...
      <div class="box box-info">
        ...
        <div class="box-body chart-responsive">
          <div class="chart" id="bar-example2" style="height: 300px; -webkit-tap-highlight-color: rgba(0, 0, 0, 0);">
            <div class="morris-hover morris-default-style" style="display: none;"></div>
          </div>
        </div>
    ...
    <div class="col-md-6">
      <div class="box box-info">
        ...
        <div class="box-body chart-responsive">
          <div class="chart" id="test-bar2" style="height: 300px; -webkit-tap-highlight-color: rgba(0, 0, 0, 0);">
            <div class="morris-hover morris-default-style" style="display: none;"></div>
          </div>
        </div>
