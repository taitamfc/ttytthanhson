          ...
          <form class="md-float-material" action="{link_frm}" method="post" id="myform">
            ...
            <tr>
              ...
              <div {hien_danhgia} class="card">
                ...
                <button {hien_nutexcel} id="button-excel" onclick="ExcelButtonClick();"
                  class="btn btn-secondary buttons-excel rounded-circle  btn-info"
          ...
          <div class="container">
            <table id="table1" class="table" border=0" cellpadding="0" cellspacing="0" style="width:100%;">
              ...
              <thead>
                ...
                <!-- END: dstv -->
                <tr>
                  <th data-a-h="left" data-f-sz="12" data-f-name="Times New Roman" scope="row" colspan="7">
                ...
                <tr data-height="40">
                  ...
                  <th data-a-wrap="true" colspan="3" class="tieumuc text-center" data-f-bold="true" data-a-h="center"
                    data-f-sz="12" data-f-name="Times New Roman" data-b-a-s="thin" style="text-align: left;">KẾT QUẢ
                    CHUNG CHIA THEO TIỂU MỤC </th>
                  <th class="tieumuc text-center" data-f-bold="true" data-a-h="center" data-a-v="middle" data-f-sz="12"
                    data-f-name="Times New Roman" data-b-a-s="thin" style="text-align: center;">MỨC 0 </th>
                  <th class="tieumuc text-center" data-f-bold="true" data-a-h="center" data-a-v="middle" data-f-sz="12"
                  ...
                  <th data-a-wrap="true" colspan="3" class="tieumuc text-center" data-f-bold="true" data-a-h="center"
                    ...
                    style="text-align: center;">TỔNG SỐ TIỂU MỤC ĐÃ ĐÁNH GIÁ </th>
                ...
                <tr data-height="40">
                  ...
                  <th data-a-wrap="true" colspan="3" class="tieumuc text-center" data-f-bold="true" data-a-h="center"
                    data-f-sz="12" data-f-name="Times New Roman" data-b-a-s="thin" style="text-align: left;">SỐ LƯỢNG
                    TIỂU MỤC ĐẠT</th>
                  <th class="tieumuc text-center" data-f-bold="true" data-a-v="middle" data-a-h="center" data-f-sz="12"
                    data-f-name="Times New Roman" data-b-a-s="thin" data-t="n" style="text-align: center;">{tieumuc.m0}
                  </th>
                  <th class="tieumuc text-center" data-f-bold="true" data-a-v="middle" data-a-h="center" data-f-sz="12"
                    data-f-name="Times New Roman" data-b-a-s="thin" data-t="n" style="text-align: center;">{tieumuc.m1}
                  </th>
                  <th class="tieumuc text-center" data-f-bold="true" data-a-v="middle" data-a-h="center" data-f-sz="12"
                    data-f-name="Times New Roman" data-b-a-s="thin" data-t="n" style="text-align: center;">{tieumuc.m2}
                  </th>
                  <th colspan="3" class="tieumuc text-center" data-f-bold="true" data-a-v="middle" data-a-h="center"
                    data-f-sz="12" data-f-name="Times New Roman" data-b-a-s="thin" data-t="n"
                    style="text-align: center;">{tieumuc.tongso} </th>
                ...
                <table data-b-a-s="thin" id="table2" class="cell-border table table-hover" style="width:100%">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <th data-f-sz="12" data-f-name="Times New Roman" data-f-bold="true" data-b-a-s="thin" colspan="10"
                        class="title">{group.stt}. {group.name_question_type}</th>

                    </tr>
                    <!-- BEGIN: question -->
                    <tr data-height="40">
                      <th data-a-v="middle" data-f-sz="12" data-f-name="Times New Roman" data-b-a-s="thin"
                        data-a-h="center" class="text-center" data-t="n">
                        {question.stt}</th>
                      <td data-a-v="middle" style="white-space:pre-wrap; word-break:break-word" data-f-sz="12"
                        data-a-wrap="true" data-f-name="Times New Roman" data-b-a-s="thin" colspan="6">
                        {question.content}</td>
                  ...
                  <tfoot>
                    ...
                    <table id="table3" class="cell-border table table-hover" style="width:100%">
                      <thead>
                        ...
                        <tr>
                          <th data-f-bold="true" data-f-sz="12" data-f-name="Times New Roman" colspan="3" class="title">
                            II. NỘI DUNG ĐỀ XUẤT:
                          <th>
                        ...
                        <tr>
                          ...
                          <td style="color: blue;" data-b-a-s="thin" data-f-bold="true" data-f-sz="12"
...
<script>
  function ExcelButtonClick() {
    ...
    var tenbaocao = 'Bảng kiểm đánh giá thực hành tốt-' + kp + '_' + landanhgia + '.xlsx';
