...
<div class="pcoded-inner-content">
  <div class="main-body">
    ...
    <div class="col-sm-12">
      ...
      <div class="card">
        <div class="card-header">
          <h5 class="m-b-10">KHỞI TẠO CÁC LẦN ĐÁNH GIÁ</h5>
        </div>
                  ...
                  <th scope="row">
                    <div class="input-group">
                      ...
                      <select name="cbo_year" class="form-control" placeholder="Chọn năm" title="" data-toggle="tooltip"
                        ...
                        <!-- BEGIN: setcbo -->
                        <option value="{setcbo.vl}">Khởi tạo lần đánh giá {setcbo.vl}</option>
                        <!-- END: setcbo-->
                  ...
                  <td>
                    <div class="input-group">
                      ...
                      <button type="submit" id="submit_button" name="submit_button"
                        ...
                        title="" data-original-title="Khởi tạo lần đánh giá trong năm">
    ...
    <div class="col-sm-12">
      ...
      <div class="card">
        <div class="card-header">
          <h5 class="m-b-10">DANH SÁCH CÁC LẦN ĐÁNH GIÁ</h5>
        </div>
        <div class="card-block icon-btn">
          <!-- BEGIN: setup -->
          <a href="{link_year}" class="{setup.class}">{setup.stt}</a>
          <!-- END: setup -->
        ...
        <div class="table-responsive" style="padding-bottom: 100px;">
          <table class="table table-hover">
            <thead>
              <tr>
                <th colspan="8" class="text-center">PHÂN BỐ CẬP NHẬT KHOA PHÒNG THEO CÁC LẦN ĐÁNH GIÁ {set_default.year}
                </th>
              </tr>
            ...
            <tbody>
              ...
              <tr>
                <th scope="row">{group_user.stt}</th>
                <td>{group_user.stt2}{group_user.tenkhoa}</td>
                <td>
                  <label class="label label-inverse-primary">
                    <b>{group_user.name_department}
                  ...
                  <div class="dropdown-success dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="dropdown-3" data-dropdown-in="fadeIn"
                      ...
                      <a onclick="del_item(&#39;/index.php?language=vi&amp;nv=qlcl&amp;op=config_chitieu&amp;sta=del_item&#39;,&#39;53ff69290067026857e0a5b982731c76_2023_12&#39;)"
                        class="dropdown-item waves-light waves-effect" href=""><i class="ti-trash"></i> Xóa</a>
                    </div>
                  </div>
                </td>
              </tr>
