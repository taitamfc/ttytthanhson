...
});$(document).ready(function() {    if ($.fn.datepicker) {        $("#fbirthday,#fdays").datepicker({            dateFormat: "dd/mm/yy",            changeMonth: true,            changeYear: true,			yearRange: "1930:2050",            showOtherMonths: true,            showOn: 'focus'        });    }    $('#to-fdays').click(function() {        $("#fdays").datepicker('show');    });    $('#from-fbirthday').click(function() {        $("#fbirthday").datepicker('show');    });		});