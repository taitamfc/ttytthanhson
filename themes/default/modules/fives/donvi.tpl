                ...
                <div class="form-group">
                    <div class="input-group" style="width:100%">
                        <span class="input-group-addon tms-addon">
                          ...
                          <select id="row_id" name="row_id" class="form-control input-sm" onchange="load_static_donvi()">
                        <!-- BEGIN: id -->
            ...
            <div class="col-xs-24 col-sm-24  col-md-12  col-lg-12">
                <div class="form-group">
                    <div class="input-group" style="width:100%">
                        ...
                        <select id="department_id" class="form-control input-sm"onchange="load_static_donvi()">
                        </select>
                    </div>
                </div>
            </div>
...
<script type="text/javascript">
   ...
   $('#row_id').select2({
        ...
        ajax: {
            url: nv_base_siteurl + 'index.php?' + nv_name_variable + '=' + nv_module_name + '&' + nv_fc_variable + '=ajax&mod=get_row_id',
            dataType: 'json',
            delay: 250,
