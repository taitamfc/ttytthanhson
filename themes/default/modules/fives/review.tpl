        ...
        <div class="col-xs-12 col-sm-12  col-md-6  col-lg-6">
            <div class="form-group">
                <div class="input-group" style="width:100%">
                    ...
                    <input type="text" readonly class="form-control input-sm" value="{STAFF}">
        ...
        <div class="col-xs-12 col-sm-12  col-md-6  col-lg-6">
            <div class="form-group">
                <div class="input-group" style="width:100%">
                    ...
                    <input type="text" readonly class="form-control input-sm" value="{TIME_DANHGIA}">
                </div>
            </div>
        </div>
        ...
        <div class="col-xs-24 col-sm-24  col-md-12  col-lg-12">
            <div class="form-group">
                <div class="input-group" style="width:100%">
                    ...
                    <select id="department_id" class="form-control input-sm" onchange="load_static_department({CONTENT.id})">
                    </select>
                </div>
            </div>
        </div>
