...
<div class="detailContent clearfix">
	...
	<!-- BEGIN: video_youtube -->
	<iframe class="detailContent clearfix" allowfullscreen="" frameborder="2" height="auto" style="min-height: 500px;" src="//www.youtube.com/embed/{CODE}?rel=0&amp;controls=1{autoplay}" width="100%"></iframe>
	<!-- END: video_youtube -->
</div>
