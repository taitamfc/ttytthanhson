...
function nv_site_theme($contents, $full = true)
{
	...
	$xtpl->assign('search', NV_BASE_SITEURL . 'themes/' . $global_config['module_theme'] . '/images/svg_fff_svg__fa-search.svg');
	$xtpl->assign('search2', NV_BASE_SITEURL . 'themes/' . $global_config['module_theme'] . '/images/svg__fa-search.svg');
	$xtpl->assign('JS', NV_BASE_SITEURL . 'themes/' . $global_config['module_theme'] . '/js');
	$xtpl->assign('image_temp', NV_BASE_SITEURL . 'themes/' . $global_config['module_theme'] . '/images/temp');
